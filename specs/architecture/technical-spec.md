...
| **5. Микро-скальпинг (Momentum Scalping)** | Тумблер Momentum Scalp (Вкл/Выкл). | Отсутствует. | Стриминг котировок (500мс). | • Расчет фазы затухания тренда.<br>• Расчет микро-целей (TP 0.25% - 0.5% / SL 0.3% - 0.5%). |
