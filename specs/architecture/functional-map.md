...
*   **Главный Баннер «SafeTrade Engine v9»:** Отображает общую ассетную оценку портфеля. Включает системные индикаторы сетевого здоровья: `Live Feed` (стабильный коннект к Supabase) и `Vault Secure` (активная защита RLS).
